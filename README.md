...
#### <a name="Stream" href="https://github.com/fluture-js/fluture-express/blob/v3.0.2/index.js#L72">`Stream :: (Number, String, NodeReadableStream) -⁠> Response a`</a>
...
#### <a name="Json" href="https://github.com/fluture-js/fluture-express/blob/v3.0.2/index.js#L78">`Json :: (Number, Object) -⁠> Response a`</a>
...
#### <a name="Redirect" href="https://github.com/fluture-js/fluture-express/blob/v3.0.2/index.js#L83">`Redirect :: (Number, String) -⁠> Response a`</a>
...
#### <a name="Empty" href="https://github.com/fluture-js/fluture-express/blob/v3.0.2/index.js#L88">`Empty :: Response a`</a>
...
#### <a name="Next" href="https://github.com/fluture-js/fluture-express/blob/v3.0.2/index.js#L93">`Next :: a -⁠> Response a`</a>
...
#### <a name="middleware" href="https://github.com/fluture-js/fluture-express/blob/v3.0.2/index.js#L148">`middleware :: ((Req, a) -⁠> Future b (Response a)) -⁠> (Req, Res a, (b -⁠> Undefined)) -⁠> Undefined`</a>
...
#### <a name="dispatcher" href="https://github.com/fluture-js/fluture-express/blob/v3.0.2/index.js#L162">`dispatcher :: String -⁠> String -⁠> (Req, Res a, (Any -⁠> Undefined)) -⁠> Undefined`</a>
